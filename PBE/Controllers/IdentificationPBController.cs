...
{
    public class IdentificationPBController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Identifier(string Matricule, int MovementID)
        {
            BK_MAN_LEDGER bk = (from mvt in db.BK_MAN_LEDGER
        ...
        [HttpPost]
        public ActionResult Reviser(string Matricule, int MovementID, string commentaire)
        {
            BK_MAN_LEDGER bk = (from mvt in db.BK_MAN_LEDGER
            ...
            {
                //db.Entry(mvt).State = EntityState.Modified;
                var dbResult = db.SP_WFC(5, Matricule, id_pj, commentaire);
                // return Json(dbResult, JsonRequestBehavior.AllowGet);
                db.SaveChanges();
                return Json("true");
            }
